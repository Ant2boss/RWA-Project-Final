<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="RWA_WebForms.Login.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div class="my-center-content">
		<h1 class="my-header">
			<asp:Label Text="Prijava" runat="server" />
		</h1>
		<hr />
		...
		<div class="my-grouper">
			...
			<asp:CustomValidator ErrorMessage="Neispravni podatci za prijavu" Text="*" CssClass="text-danger" OnServerValidate="CustomValidator_ServerValidate" runat="server" />
		...
		<asp:Button Text="Prijavi se" CssClass="btn btn-success btn-sm w-50 m-auto" runat="server" />
